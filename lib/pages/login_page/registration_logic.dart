...
class RegistrationLogic extends ChangeNotifier{
  ...
  static final List<OwnerAuth> _allCustomers = [];

  List<OwnerAuth> get getAllCustomers {
    List<OwnerAuth> list = [... _allCustomers];
    return list;
  }
...
void addNewCustomer (OwnerAuth customer){
  Uuid uuid = const Uuid();
  OwnerAuth _newCustomer = customer;
